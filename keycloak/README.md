...
`users-roles-write`, `users-password-reset`, `users-profiles-write`, `ops-metrics`, `ops-write`.
...
|---|---|
| `view-users` | Leer usuarios y sus role-mappings |
| `query-users` | Buscar y contar usuarios |
| `manage-users` | Crear, modificar, habilitar/deshabilitar, borrar, fijar contraseñas, enviar acciones por correo y cambiar los role-mappings (de realm y de cliente) de un usuario |
